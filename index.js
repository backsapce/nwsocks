...
function checkConfig(config) {
	let METHODS = ['aes-128-cfb','aes-192-cfb','aes-256-cfb','bf-cfb','camellia-128-cfb','camellia-192-cfb','camellia-256-cfb','cast5-cfb','des-cfb','idea-cfb','rc2-cfb','rc4','rc4-md5','seed-cfb'];
	if (!config) {
